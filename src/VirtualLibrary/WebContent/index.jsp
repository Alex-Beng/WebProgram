	  ...
	  <div class="header">
        ...
        <div class="login_area">
            ...
            <div class="login_box">
				...
				<a href="http://www.gzlib.org.cn/login.jspx?returnUrl=http%3A%2F%2Fwww.gzlib.org.cn%2F&amp;locale=zh_CN"  title="登录" class="newicon ni-login">登录</a> 
        ...
        <div class="top_nav" >
			<div class="top_nav">
				...
				<div class="top_nav_link">
							...
							<a href="aboutlib/index.htm" title="关于广图" alt="关于憨图"   target="_self">关于憨图</a>
				</div>
			</div>  
        ...
        <div class="contain">
			...
			<!-- 搜索 -->
                <div id="search" class="search_box ">
                    <div class="logo_box">
                        <img src="/VirtualLibrary/images/logo.png" alt="广图"/>
                    </div>
                    <!-- 搜索form -->
